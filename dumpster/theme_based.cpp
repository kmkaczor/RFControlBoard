...
// void * theme_simple
//#define theme_def (*(my_theme_t **)(&&lvglobal) ->theme_based))
//#define theme_def (*(my_theme_t **)(void * theme_based))
...
#define COLOR_DIM     lv_palette_darken(LV_PALETTE_GREY, 3)
...
my_theme_t* theme_def = &theme_based;
/**********************
 *  STATIC PROTOTYPES
 **********************/
